...
BEGIN {
	...
	export_types_ai["convoy_x::is_followed"] = "integer()"
	export_types_ai["convoy_x::set_followed"] = "integer()"
	export_types_ai["convoy_x::is_loading"] = "bool()"
	export_types_ai["convoy_x::has_no_route"] = "bool()"
	export_types_ai["convoy_x::is_stuck"] = "bool()"
	...
	export_types_ai["factory_x::get_target_cities"] = "array<city_x>()"
	...
	export_types_ai["way_desc_x::get_default_way_desc"] = "way_desc_x(way_types)"
	...
	export_types_ai["bridge_desc_x::get_desc"] = "bridge_desc_x(string)"
	...
	export_types_ai["halt_x::get_owners"] = "integer()"
	export_types_ai["halt_x::can_use_halt"] = "bool(player_x)"
	export_types_ai["halt_x::get_permissions"] = "integer()"
	export_types_ai["halt_x::set_permissions"] = "void(halt_x, integer)"
	...
	export_types_ai["halt_x::is_rerouting_finished"] = "bool()"
	...
	export_types_ai["::get_tool_key"] = "string(integer)"
	...
	export_types_ai["way_planner_x::set_build_types"] = "void(way_desc_x, bool)"
	export_types_ai["way_planner_x::is_allowed_step"] = "bool(tile_x, tile_x)"
	export_types_ai["way_planner_x::get_step_cost"] = "integer(tile_x, tile_x)"
	export_types_ai["bridge_planner_x::find_end"] = "coord3d(player_x, coord3d, dir, bridge_desc_x, integer, integer, bool)"
	export_types_ai["tunnel_planner_x::find_end"] = "coord3d(player_x, coord3d, dir, tunnel_desc_x)"
	export_types_ai["command_x::get_flags"] = "integer()"
	export_types_ai["command_x::set_flags"] = "void(integer)"
	export_types_ai["command_x::build_way"] = "string(player_x, coord3d, coord3d, way_desc_x, bool, bool)"
	export_types_ai["command_x::build_road"] = "string(player_x, coord3d, coord3d, way_desc_x, bool, bool, bool)"
	export_types_ai["command_x::build_depot"] = "string(player_x, coord3d, building_desc_x)"
	export_types_ai["command_x::build_station"] = "string(player_x, coord3d, building_desc_x, integer)"
	export_types_ai["command_x::build_bridge"] = "string(player_x, coord3d, coord3d, bridge_desc_x)"
	export_types_ai["command_x::build_bridge_at"] = "string(player_x, coord3d, bridge_desc_x, integer)"
