...
#define PRIVATE_KEY (0xE000u)

	/* Function keys */
	SIM_KEYCODE_F1          = PRIVATE_KEY + 256,
	SIM_KEYCODE_F2          = PRIVATE_KEY + 257,
	SIM_KEYCODE_F3          = PRIVATE_KEY + 258,
	SIM_KEYCODE_F4          = PRIVATE_KEY + 259,
	SIM_KEYCODE_F5          = PRIVATE_KEY + 260,
	SIM_KEYCODE_F6          = PRIVATE_KEY + 261,
	SIM_KEYCODE_F7          = PRIVATE_KEY + 262,
	SIM_KEYCODE_F8          = PRIVATE_KEY + 263,
	SIM_KEYCODE_F9          = PRIVATE_KEY + 264,
	SIM_KEYCODE_F10         = PRIVATE_KEY + 265,
	SIM_KEYCODE_F11         = PRIVATE_KEY + 266,
	SIM_KEYCODE_F12         = PRIVATE_KEY + 267,
	SIM_KEYCODE_F13         = PRIVATE_KEY + 268,
	SIM_KEYCODE_F14         = PRIVATE_KEY + 269,
	SIM_KEYCODE_F15         = PRIVATE_KEY + 270,

	/* other navigation keys */
	SIM_KEYCODE_HOME        = PRIVATE_KEY + 275,
	SIM_KEYCODE_END         = PRIVATE_KEY + 276,
	SIM_KEYCODE_PGUP        = PRIVATE_KEY + 277,
	SIM_KEYCODE_PGDN        = PRIVATE_KEY + 278,
	SIM_KEYCODE_SCROLLLOCK  = PRIVATE_KEY + 279,

	SIM_KEYCODE_PAUSE       = PRIVATE_KEY + 279,

	/* arrow (direction) keys */
	SIM_KEYCODE_NUMPAD_BASE = PRIVATE_KEY + 280, // 0 on keypad
